...
vspec = importlib.util.spec_from_file_location(
  "version",
  str(Path(__file__).resolve().parent / 'shapeit' / "version.py")
)
...
setup(
    name='shapeit',
    description="It's Shapely with projections and some other conveniences!",
    ...
    url='https://github.com/patdaburu/shapeit',
    download_url=(
        f'https://github.com/patdaburu/'
        f'shapeit/archive/{version}.tar.gz'
    ),
    keywords=[
